...
class Game:
    ...
    def musica_fondo(self):
        pygame.mixer.music.load("Pygame/resources/bg_music_1.mp3")
        pygame.mixer.music.play(-1, 0)
    
    def sonido(self,sound_name):
        if sound_name == "crash":
            sound = pygame.mixer.Sound("Pygame/resources/crash.mp3")
        elif sound_name == 'ding':
            sound = pygame.mixer.Sound("Pygame/resources/ding.mp3")
